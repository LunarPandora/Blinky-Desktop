...
public class FormProdi{
    ...
    public FormProdi(Stage rStage, Home h, String type, Prodi obj){
        home = h;
        data = obj;
    ...
    public VBox createFormEdit(){
        ...
        Text formTitle = new Text("Edit Prodi");
        
        Button btnAcc = new Button("Perbarui");
        btnAcc.setMaxWidth(Double.MAX_VALUE);
        btnAcc.setOnAction(e -> {
            data.setNmProdi(getInputValue("nmProdi"));
    ...
    public VBox createFormDelete(){
        ...
        Text formTitle = new Text("Hapus Prodi");
        Text formSubtitle = new Text("Apakah anda yakin ingin menghapus mata kuliah '" + data.getNmProdi() + "' ?");
