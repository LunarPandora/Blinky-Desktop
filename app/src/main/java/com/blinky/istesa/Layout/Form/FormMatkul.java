...
public class FormMatkul{
    ...
    private static Matkul data;

    private static Input[] formInputList = new Input[]{
        new Input("nmMatkul", new Label("Nama Mata Kuliah"), new TextField(), 1, "Masukkan nama matkul").setType("TextField")
    };

    private static List<Input> readyInput = new ArrayList<Input>();

    public FormMatkul(Stage rStage, Home h, String type){
        home = h;
    ...
    public FormMatkul(Stage rStage, Home h, String type, Matkul obj){
        home = h;
        data = obj;
    ...
    public VBox createFormEdit(){
        ...
        Text formTitle = new Text("Edit Mata Kuliah");
        
        Button btnAcc = new Button("Perbarui");
        btnAcc.setMaxWidth(Double.MAX_VALUE);
        btnAcc.setOnAction(e -> {
            data.setNmMatkul(getInputValue("nmMatkul"));
    ...
    public VBox createFormDelete(){
        ...
        Text formTitle = new Text("Hapus Mata Kuliah");
        Text formSubtitle = new Text("Apakah anda yakin ingin menghapus mata kuliah '" + data.getNmMatkul() + "' ?");
