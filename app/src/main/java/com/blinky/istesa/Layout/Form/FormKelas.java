...
public class FormKelas{
    ...
    private static Kelas data;

    private static Input[] formInputList = new Input[]{
        new Input("nmKelas", new Label("Nama Kelas"), new TextField(), 1, "Masukkan nama kelas").setType("TextField")
    };

    private static List<Input> readyInput = new ArrayList<Input>();

    public FormKelas(Stage rStage, Home h, String type){
        home = h;
    ...
    public FormKelas(Stage rStage, Home h, String type, Kelas obj){
        home = h;
        data = obj;
    ...
    public VBox createFormEdit(){
        ...
        Text formTitle = new Text("Edit Kelas");
        
        Button btnAcc = new Button("Perbarui");
        btnAcc.setMaxWidth(Double.MAX_VALUE);
        btnAcc.setOnAction(e -> {
            data.setNmKelas(getInputValue("nmKelas"));
    ...
    public VBox createFormDelete(){
        ...
        Text formTitle = new Text("Hapus Kelas");
        Text formSubtitle = new Text("Apakah anda yakin ingin menghapus mata kuliah '" + data.getNmKelas() + "' ?");
