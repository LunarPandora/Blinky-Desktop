...
public class FormDosen{
    ...
    private static Input[] formInputList = new Input[]{
        new Input("nmDosen", new Label("Nama Dosen"), new TextField(), 1, "Masukkan nama dosen").setType("TextField"),
        new Input("uDosen", new Label("Username Dosen"), new TextField(), 2, "Masukkan username dosen").setType("TextField"),
        new Input("pwDosen", new Label("Password Dosen"), new PasswordField(), 3, "Masukkan password dosen").setType("TextField"),
    ...
    public VBox createFormDelete(){
        ...
        Text formSubtitle = new Text("Apakah anda yakin ingin menghapus dosen '" + data.getNmDosen() + "' ?");
