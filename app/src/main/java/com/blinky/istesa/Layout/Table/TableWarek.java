...
public class TableWarek extends Table{
    private Warek selectedData;
    ...
    public TableView<Warek> createTable(){
        ...
        tb.setRowFactory(tv -> {
            TableRow<Warek> row = new TableRow<>();
            row.setOnMouseClicked(e -> {
                if(!row.isEmpty()) {
                    Warek rowData = row.getItem();
    ...
    public void setSelectedData(Warek sd){
        selectedData = sd;
    }

    public Warek getSelectedData(){
        return selectedData;
    }
